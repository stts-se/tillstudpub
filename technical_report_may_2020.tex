...
github.com/stts-se/tillstudpub. These consist of a small client-server
...
\item {\tt audio\_streaming} streams microphone audio from the browser
  to a server. There are two different methods used in the browser, one
  using { \tt ScriptProcessorNode}, the other using {\tt
    AudioWorklet}, a more recent approch.

\item {\tt webrtc\_demo} a sketchy example of using the WebRTC
  protocal for streaming audio to a server. Not a fully functioning
